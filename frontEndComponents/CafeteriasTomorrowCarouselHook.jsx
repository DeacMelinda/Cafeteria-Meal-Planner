...
import TomorrowCarousel from "./TomorrowCarousel";

const CAFETERIA_GET_URL = "http://localhost:8081/cafeteriausersapi/cafeteriaUsers/";

export const CafeteriasTomorrowCarouselHook = () => {    
    ...
    return <TomorrowCarousel data={data.cafeterias} isFetching={data.isFetching}/>;
